...
import { concurrencyImplementations } from "./concepts/concurrency/implementations";

export const conceptImplementations: Record<string, ConceptImplementation[]> = {
  ...concurrencyImplementations,
