...
const COMMENT_PREFIX: Record<LanguageId, string> = {
  python: "#",
  typescript: "//",
  javascript: "//",
  rust: "//",
...
function preserveLeadingComments(code: string, from: LanguageId, targetComment: string): string {
...
function recommendImports(from: LanguageId, to: LanguageId, result: TranslationResult): string[] {
  ...
  if (result.concepts?.includes("data-structures.list") || result.concepts?.includes("data-structures.map")) {
    ...
    if (to === "swift") imports.push("Foundation");
    if (to === "dart") imports.push("dart:collection");
  }
  if (from === "python" && to === "typescript") imports.push("node:fs");
  return Array.from(new Set(imports));
}

function basicTranslate(from: LanguageId, to: LanguageId, code: string): TranslationResult {
...
function detectBasicPattern(language: LanguageId, code: string): BasicPattern | null {
...
function detectDataclassPattern(code: string): BasicPattern | null {
...
function detectDecoratorPattern(code: string): BasicPattern | null {
...
function detectAsyncPattern(code: string): BasicPattern | null {
...
function detectErrorHandlingPattern(code: string): BasicPattern | null {
...
function detectGenericsPattern(code: string): BasicPattern | null {
...
function detectIteratorPattern(code: string): BasicPattern | null {
...
function detectPatternMatchingPattern(code: string): BasicPattern | null {
...
function detectConcurrencyPattern(code: string): BasicPattern | null {
...
function renderPattern(pattern: BasicPattern, to: LanguageId): string {
  switch (pattern.id) {
...
function renderList(params: Record<string, string>, to: LanguageId): string {
...
function renderMap(params: Record<string, string>, to: LanguageId): string {
...
function renderDataclass(params: Record<string, string>, to: LanguageId): string {
...
function renderDecorator(params: Record<string, string>, to: LanguageId): string {
...
function renderAsync(to: LanguageId): string {
  switch (to) {
    case "python":
...
function renderErrorHandling(to: LanguageId): string {
  switch (to) {
    case "python":
...
function renderGenerics(to: LanguageId): string {
  switch (to) {
    case "python":
...
function renderIterators(to: LanguageId): string {
  switch (to) {
    case "python":
...
function renderPatternMatching(to: LanguageId): string {
  switch (to) {
    case "python":
      return "match value:\n    case 1: print('one')\n    case _: print('other')";
    case "typescript":
...
function renderConcurrency(to: LanguageId): string {
  switch (to) {
    case "python":
