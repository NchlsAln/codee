...
const spring_1 = require("./templates/spring");
const jpa_1 = require("./templates/jpa");
    ...
    constructor() {
        super("java", {
            idioms: [
                ...
                "Favor streams for collection pipelines."
            ],
            templates: {
                "stdlib.collections": (0, stdlib_1.collectionsTemplate)(),
                "stdlib.io": (0, stdlib_1.ioTemplate)(),
            ...
            frameworkTemplates: {
                "spring.controller": (0, spring_1.controllersTemplate)(),
                "spring.service": (0, spring_1.servicesTemplate)(),
                "spring.repository": (0, spring_1.repositoriesTemplate)(),
                "jpa.entity": (0, jpa_1.jpaTemplate)(),
                "android.activity": (0, android_1.androidTemplate)()
            },
            testTemplates: {
                junit: (0, unit_1.unitTemplate)()
            }
        });
    }
}
