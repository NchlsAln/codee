...
import { collectionsTemplate, ioTemplate } from "./templates/stdlib";
import { controllersTemplate, servicesTemplate, repositoriesTemplate } from "./templates/spring";
import { jpaTemplate } from "./templates/jpa";
import { androidTemplate } from "./templates/android";
...
export class CodeTemplates extends BaseCodeTemplates {
  constructor() {
    super("java", {
      ...
      frameworkTemplates: {
        "spring.controller": controllersTemplate(),
        "spring.service": servicesTemplate(),
        "spring.repository": repositoriesTemplate(),
        "jpa.entity": jpaTemplate(),
        "android.activity": androidTemplate()
      },
      testTemplates: {
        junit: unitTemplate()
      }
