...
exports.inferAnsibleTypes =
  exports.ansibleAstPatterns =
  exports.ansibleIdioms =
...
Object.defineProperty(exports, "ansibleRuntime", {
  enumerable: true,
  get: function () {
    return runtime_1.ansibleRuntime;
  },
});
const ecosystem_1 = require("./implementation/ecosystem");
Object.defineProperty(exports, "ansibleEcosystem", {
  enumerable: true,
  get: function () {
    return ecosystem_1.ansibleEcosystem;
  },
});
const idioms_1 = require("./implementation/idioms");
Object.defineProperty(exports, "ansibleIdioms", {
  enumerable: true,
  get: function () {
    return idioms_1.ansibleIdioms;
  },
});
const ast_patterns_1 = require("./analysis/ast-patterns");
Object.defineProperty(exports, "ansibleAstPatterns", {
  enumerable: true,
  get: function () {
    return ast_patterns_1.ansibleAstPatterns;
  },
});
const type_inference_1 = require("./analysis/type-inference");
Object.defineProperty(exports, "inferAnsibleTypes", {
  enumerable: true,
  get: function () {
    return type_inference_1.inferAnsibleTypes;
  },
});
exports.ansibleDefinition = {
  id: "ansible",
