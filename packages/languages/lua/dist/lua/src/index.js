...
exports.inferLuaTypes = exports.luaAstPatterns = exports.luaIdioms = exports.luaEcosystem = exports.luaRuntime = exports.PromptEngineering = exports.CodeTemplates = exports.LanguageServer = exports.LanguageAnalyzer = exports.luaDefinition = void 0;
...
Object.defineProperty(exports, "luaRuntime", { enumerable: true, get: function () { return runtime_1.luaRuntime; } });
const ecosystem_1 = require("./implementation/ecosystem");
Object.defineProperty(exports, "luaEcosystem", { enumerable: true, get: function () { return ecosystem_1.luaEcosystem; } });
const idioms_1 = require("./implementation/idioms");
Object.defineProperty(exports, "luaIdioms", { enumerable: true, get: function () { return idioms_1.luaIdioms; } });
const ast_patterns_1 = require("./analysis/ast-patterns");
Object.defineProperty(exports, "luaAstPatterns", { enumerable: true, get: function () { return ast_patterns_1.luaAstPatterns; } });
const type_inference_1 = require("./analysis/type-inference");
Object.defineProperty(exports, "inferLuaTypes", { enumerable: true, get: function () { return type_inference_1.inferLuaTypes; } });
exports.luaDefinition = {
    id: "lua",
    name: "Lua",
    extensions: [
        ".ext"
