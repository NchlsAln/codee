...
import { ktorServerTemplate } from "./templates/ktor/server";
import { springBootTemplate } from "./templates/spring/boot";
import { composeTemplate } from "./templates/android/compose";
import { koinDiTemplate } from "./templates/koin/di";
...
export class CodeTemplates extends BaseCodeTemplates {
  constructor() {
    super("kotlin", {
      ...
      frameworkTemplates: {
        "ktor.server": ktorServerTemplate(),
        "spring.boot": springBootTemplate(),
        "android.compose": composeTemplate(),
        "koin.di": koinDiTemplate()
      },
      testTemplates: {
        kotest: unitTemplate()
      }
