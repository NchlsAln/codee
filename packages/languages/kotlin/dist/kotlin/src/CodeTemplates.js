...
const server_2 = require("./templates/ktor/server");
const boot_1 = require("./templates/spring/boot");
const compose_1 = require("./templates/android/compose");
const di_1 = require("./templates/koin/di");
class CodeTemplates extends lang_common_1.BaseCodeTemplates {
    constructor() {
        super("kotlin", {
            idioms: ["Prefer data classes.", "Use null safety effectively.", "Prefer val over var.", "Use coroutines."],
            templates: {
            ...
            frameworkTemplates: {
                "ktor.server": (0, server_2.ktorServerTemplate)(),
                "spring.boot": (0, boot_1.springBootTemplate)(),
                "android.compose": (0, compose_1.composeTemplate)(),
                "koin.di": (0, di_1.koinDiTemplate)()
            },
            testTemplates: {
                kotest: (0, unit_1.unitTemplate)()
            }
        });
    }
}
