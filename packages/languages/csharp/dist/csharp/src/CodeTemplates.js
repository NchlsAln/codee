...
const minimal_api_1 = require("./templates/aspnet/minimal-api");
const dbcontext_1 = require("./templates/entityframework/dbcontext");
const test_1 = require("./templates/xunit/test");
const component_1 = require("./templates/blazor/component");
class CodeTemplates extends lang_common_1.BaseCodeTemplates {
    constructor() {
        super("csharp", {
            idioms: ["Follow .NET conventions.", "Prefer async/await for IO.", "Use records for data."],
            templates: {
            ...
            frameworkTemplates: {
                "aspnet.minimal": (0, minimal_api_1.aspNetMinimalApiTemplate)(),
                "entityframework.dbcontext": (0, dbcontext_1.efCoreTemplate)(),
                "xunit.test": (0, test_1.xunitTestTemplate)(),
                "blazor.component": (0, component_1.blazorComponentTemplate)()
            },
            testTemplates: {
                xunit: (0, test_1.xunitTestTemplate)()
            }
        });
    }
}
