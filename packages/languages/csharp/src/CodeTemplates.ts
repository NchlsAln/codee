...
import { aspNetMinimalApiTemplate } from "./templates/aspnet/minimal-api";
import { efCoreTemplate } from "./templates/entityframework/dbcontext";
import { xunitTestTemplate } from "./templates/xunit/test";
import { blazorComponentTemplate } from "./templates/blazor/component";
...
export class CodeTemplates extends BaseCodeTemplates {
  constructor() {
    super("csharp", {
      ...
      frameworkTemplates: {
        "aspnet.minimal": aspNetMinimalApiTemplate(),
        "entityframework.dbcontext": efCoreTemplate(),
        "xunit.test": xunitTestTemplate(),
        "blazor.component": blazorComponentTemplate()
      },
      testTemplates: {
        xunit: xunitTestTemplate()
      }
    });
  }
}
