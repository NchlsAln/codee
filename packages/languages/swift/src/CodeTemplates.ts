...
import { swiftUiTemplate } from "./templates/swiftui/view";
import { vaporRouteTemplate } from "./templates/vapor/route";
import { combinePipelineTemplate } from "./templates/combine/publisher";
import { urlSessionTemplate } from "./templates/urlsession/request";
...
export class CodeTemplates extends BaseCodeTemplates {
  constructor() {
    super("swift", {
      ...
      frameworkTemplates: {
        "swiftui.view": swiftUiTemplate(),
        "vapor.route": vaporRouteTemplate(),
        "combine.publisher": combinePipelineTemplate(),
        "urlsession.request": urlSessionTemplate()
      },
      testTemplates: {
        xctest: unitTemplate()
      }
