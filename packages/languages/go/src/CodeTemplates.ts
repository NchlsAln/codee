...
import { ginTemplate } from "./templates/gin";
import { gorillaTemplate } from "./templates/gorilla";
import { stdlibTemplate } from "./templates/stdlib";
...
export class CodeTemplates extends BaseCodeTemplates {
  constructor() {
    super("go", {
      ...
      templates: {
        "stdlib.net-http": stdlibTemplate(),
      ...
      frameworkTemplates: {
        "gorilla.mux": gorillaTemplate(),
        "gin.route": ginTemplate()
      },
      testTemplates: {
        gotest: unitTemplate()
      }
