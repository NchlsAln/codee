...
const gin_1 = require("./templates/gin");
const gorilla_1 = require("./templates/gorilla");
    ...
    constructor() {
        super("go", {
            idioms: [
                ...
                "Use small interfaces and compose behavior.",
                "Leverage zero values and avoid nil checks when possible."
            ],
            templates: {
                "stdlib.net-http": (0, stdlib_1.stdlibTemplate)(),
            ...
            frameworkTemplates: {
                "gorilla.mux": (0, gorilla_1.gorillaTemplate)(),
                "gin.route": (0, gin_1.ginTemplate)()
            },
            testTemplates: {
                gotest: (0, unit_1.unitTemplate)()
            }
        });
    }
}
