...
import { playControllerTemplate } from "./templates/play/controller";
import { akkaActorTemplate } from "./templates/akka/actor";
import { sparkJobTemplate } from "./templates/spark/job";
import { zioEffectTemplate } from "./templates/zio/effect";
...
export class CodeTemplates extends BaseCodeTemplates {
  constructor() {
    super("scala", {
      ...
      frameworkTemplates: {
        "play.controller": playControllerTemplate(),
        "akka.actor": akkaActorTemplate(),
        "spark.job": sparkJobTemplate(),
        "zio.effect": zioEffectTemplate()
      },
      testTemplates: {
        scalatest: unitTemplate()
      }
    });
  }
}
