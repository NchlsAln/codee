...
const controller_1 = require("./templates/play/controller");
const actor_1 = require("./templates/akka/actor");
const job_1 = require("./templates/spark/job");
const effect_1 = require("./templates/zio/effect");
class CodeTemplates extends lang_common_1.BaseCodeTemplates {
    constructor() {
        super("scala", {
            idioms: ["Prefer immutability.", "Use pattern matching.", "Use case classes."],
            templates: {
            ...
            frameworkTemplates: {
                "play.controller": (0, controller_1.playControllerTemplate)(),
                "akka.actor": (0, actor_1.akkaActorTemplate)(),
                "spark.job": (0, job_1.sparkJobTemplate)(),
                "zio.effect": (0, effect_1.zioEffectTemplate)()
            },
            testTemplates: {
                scalatest: (0, unit_1.unitTemplate)()
            }
        });
    }
}
