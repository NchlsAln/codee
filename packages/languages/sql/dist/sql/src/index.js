...
exports.inferSqlTypes = exports.sqlAstPatterns = exports.sqlIdioms = exports.sqlEcosystem = exports.sqlRuntime = exports.PromptEngineering = exports.CodeTemplates = exports.LanguageServer = exports.LanguageAnalyzer = exports.sqlDefinition = void 0;
...
Object.defineProperty(exports, "sqlRuntime", { enumerable: true, get: function () { return runtime_1.sqlRuntime; } });
const ecosystem_1 = require("./implementation/ecosystem");
Object.defineProperty(exports, "sqlEcosystem", { enumerable: true, get: function () { return ecosystem_1.sqlEcosystem; } });
const idioms_1 = require("./implementation/idioms");
Object.defineProperty(exports, "sqlIdioms", { enumerable: true, get: function () { return idioms_1.sqlIdioms; } });
const ast_patterns_1 = require("./analysis/ast-patterns");
Object.defineProperty(exports, "sqlAstPatterns", { enumerable: true, get: function () { return ast_patterns_1.sqlAstPatterns; } });
const type_inference_1 = require("./analysis/type-inference");
Object.defineProperty(exports, "inferSqlTypes", { enumerable: true, get: function () { return type_inference_1.inferSqlTypes; } });
exports.sqlDefinition = {
    id: "sql",
    name: "SQL",
    extensions: [
        ".sql"
