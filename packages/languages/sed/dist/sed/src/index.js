...
exports.inferSedTypes = exports.sedAstPatterns = exports.sedIdioms = exports.sedEcosystem = exports.sedRuntime = exports.PromptEngineering = exports.CodeTemplates = exports.LanguageServer = exports.LanguageAnalyzer = exports.sedDefinition = void 0;
...
Object.defineProperty(exports, "sedRuntime", { enumerable: true, get: function () { return runtime_1.sedRuntime; } });
const ecosystem_1 = require("./implementation/ecosystem");
Object.defineProperty(exports, "sedEcosystem", { enumerable: true, get: function () { return ecosystem_1.sedEcosystem; } });
const idioms_1 = require("./implementation/idioms");
Object.defineProperty(exports, "sedIdioms", { enumerable: true, get: function () { return idioms_1.sedIdioms; } });
const ast_patterns_1 = require("./analysis/ast-patterns");
Object.defineProperty(exports, "sedAstPatterns", { enumerable: true, get: function () { return ast_patterns_1.sedAstPatterns; } });
const type_inference_1 = require("./analysis/type-inference");
Object.defineProperty(exports, "inferSedTypes", { enumerable: true, get: function () { return type_inference_1.inferSedTypes; } });
exports.sedDefinition = {
    id: "sed",
    name: "sed",
    extensions: [".sed"],
