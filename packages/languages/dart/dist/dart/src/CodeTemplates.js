...
const widget_1 = require("./templates/flutter/widget");
const route_1 = require("./templates/shelf/route");
const route_2 = require("./templates/dart-frog/route");
const cubit_1 = require("./templates/bloc/cubit");
class CodeTemplates extends lang_common_1.BaseCodeTemplates {
    constructor() {
        super("dart", {
            idioms: ["Prefer const constructors.", "Use named parameters.", "Use final for immutability."],
            templates: {
            ...
            frameworkTemplates: {
                "flutter.widget": (0, widget_1.flutterWidgetTemplate)(),
                "shelf.route": (0, route_1.shelfRouteTemplate)(),
                "dart_frog.route": (0, route_2.dartFrogTemplate)(),
                "bloc.cubit": (0, cubit_1.blocTemplate)()
            },
            testTemplates: {
                test: (0, unit_1.unitTemplate)()
            }
        });
    }
}
