...
import { flutterWidgetTemplate } from "./templates/flutter/widget";
import { shelfRouteTemplate } from "./templates/shelf/route";
import { dartFrogTemplate } from "./templates/dart-frog/route";
import { blocTemplate } from "./templates/bloc/cubit";
...
export class CodeTemplates extends BaseCodeTemplates {
  constructor() {
    super("dart", {
      ...
      frameworkTemplates: {
        "flutter.widget": flutterWidgetTemplate(),
        "shelf.route": shelfRouteTemplate(),
        "dart_frog.route": dartFrogTemplate(),
        "bloc.cubit": blocTemplate()
      },
      testTemplates: {
        test: unitTemplate()
      }
